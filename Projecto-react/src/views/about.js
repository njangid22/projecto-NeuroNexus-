...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>about - Worn Green Chough</title>
        <meta property="og:title" content="about - Worn Green Chough" />
      </Helmet>
      <header data-role="Header" className="about-header">
        ...
        <div data-role="MobileMenu" className="about-mobile-menu">
          ...
          <div>
            <svg viewBox="0 0 950.8571428571428 1024" className="about-icon06">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="about-icon08">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="about-icon10">
      ...
      <div className="about-banner">
        ...
        <div className="about-container03">
          <div className="about-container04"></div>
        </div>
        <span className="about-text03">
          A amazing place to assign project and give marks!
        </span>
        <h1 className="about-text04">Features</h1>
        <span className="about-text05">
          you can give and take quiz with full transparency with individual
          Question marking.
        </span>
        <h1 className="about-text06">pricing</h1>
        <div className="about-container05">
          <div className="about-container06">
            <h1>Pricing Plans</h1>
            <span className="about-text08">
              only for firms and job seeker with mentors.
            </span>
          </div>
          <div className="about-container07">
            <div className="about-container08">
              <span className="about-text09">Free</span>
              <span className="about-text10">$0</span>
              <span className="about-text11">
                <span className="about-text12">10</span>
                <span> Projects</span>
              </span>
              <span className="about-text14">
                <span className="about-text15">99</span>
                <span> Components</span>
              </span>
              <span className="about-text17">
                <span className="about-text18">3</span>
                <span> Collaborators</span>
              </span>
              <span className="about-text20">
                <span className="about-text21">Public projects</span>
              </span>
              <button className="about-button Heading button">
                Learn More
              </button>
            </div>
            <div className="about-container09">
              <span className="about-text22">Premium</span>
              <span className="about-text23">$29</span>
              <span className="about-text24">
                <span className="about-text25">100</span>
                <span> Projects</span>
              </span>
              <span className="about-text27">
                <span className="about-text28">1000</span>
                <span> Components</span>
              </span>
              <span className="about-text30">
                <span className="about-text31">20</span>
                <span> Collaborators</span>
              </span>
              <span className="about-text33">
                <span className="about-text34">Private projects</span>
              </span>
              <button className="about-button1 Heading button">
                Learn More
              </button>
            </div>
          </div>
        </div>
        <h1 className="about-text35">Team</h1>
        <span className="about-text36">vit-ap</span>
        <h1 className="about-text37">Blog</h1>
        <span className="about-text38">https://www.neuronexus.com/blog/</span>
      </div>
      <footer className="about-footer">
        ...
        >
          <svg viewBox="0 0 877.7142857142857 1024" className="about-icon14">
            <path d="M585.143 512c0-80.571-65.714-146.286-146.286-146.286s-146.286 65.714-146.286 146.286 65.714 146.286 146.286 146.286 146.286-65.714 146.286-146.286zM664 512c0 124.571-100.571 225.143-225.143 225.143s-225.143-100.571-225.143-225.143 100.571-225.143 225.143-225.143 225.143 100.571 225.143 225.143zM725.714 277.714c0 29.143-23.429 52.571-52.571 52.571s-52.571-23.429-52.571-52.571 23.429-52.571 52.571-52.571 52.571 23.429 52.571 52.571zM438.857 152c-64 0-201.143-5.143-258.857 17.714-20 8-34.857 17.714-50.286 33.143s-25.143 30.286-33.143 50.286c-22.857 57.714-17.714 194.857-17.714 258.857s-5.143 201.143 17.714 258.857c8 20 17.714 34.857 33.143 50.286s30.286 25.143 50.286 33.143c57.714 22.857 194.857 17.714 258.857 17.714s201.143 5.143 258.857-17.714c20-8 34.857-17.714 50.286-33.143s25.143-30.286 33.143-50.286c22.857-57.714 17.714-194.857 17.714-258.857s5.143-201.143-17.714-258.857c-8-20-17.714-34.857-33.143-50.286s-30.286-25.143-50.286-33.143c-57.714-22.857-194.857-17.714-258.857-17.714zM877.714 512c0 60.571 0.571 120.571-2.857 181.143-3.429 70.286-19.429 132.571-70.857 184s-113.714 67.429-184 70.857c-60.571 3.429-120.571 2.857-181.143 2.857s-120.571 0.571-181.143-2.857c-70.286-3.429-132.571-19.429-184-70.857s-67.429-113.714-70.857-184c-3.429-60.571-2.857-120.571-2.857-181.143s-0.571-120.571 2.857-181.143c3.429-70.286 19.429-132.571 70.857-184s113.714-67.429 184-70.857c60.571-3.429 120.571-2.857 181.143-2.857s120.571-0.571 181.143 2.857c70.286 3.429 132.571 19.429 184 70.857s67.429 113.714 70.857 184c3.429 60.571 2.857 120.571 2.857 181.143z"></path>
          </svg>
        </a>
        <a
        ...
        <div className="about-container10"></div>
      </footer>
    </div>
  )
}
